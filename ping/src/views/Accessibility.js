...
function AccessibilityScreen(){
  ...
  return (
    <main id="accessibilityScreen" className='centeredScreen'>
      ...
      <Slider setSliderVal={'volume'} title={'Sound volume'} description={'Volume of the game sounds. \rDefault: 60'} sliderVal = {storedOptions.volume} min = {0} max = {100} step = {10}></Slider>
